...
public:
    ...
    Lista linea1(){
        linea->anadir_final(tiempoProcesoA());
        linea->anadir_final(tiempoProcesoB());
        linea->anadir_final(tiempoProcesoC());
        linea->anadir_final(tiempoProcesoD());
        linea->anadir_final(tiempoProcesoE());
        linea->anadir_final(tiempoProcesoF());
        return *linea;
    }
};
...
int tiempoDeLlegada[6], tiempoTotalAux[6], TiempoFinal[6]={0}, quantum, rqi[50]={0}, st, flag=0, Time=0, noe=0, proceso=0, tiempoTotal[6]={0}, tiempoDeRespuesta, tiempoDeEspera;
float att, awt ;
...
void roundRobin(Lista lineaProceso,int carro){
    cout<<"\n \n";
    for(int i=0;i<6;i++){
        tiempoTotalAux[i]=lineaProceso.obtener_dato(i);
    ...
    do{
        if(flag==0){
            ...
            if(tiempoTotal[0]<=quantum){
                ...
                tiempoTotal[0]=0;
                cout<<"\n >>>   [el primer proceso finalizo porque el tiempo total es menor o igual al quantum]\n   ";
                linea1=NULL;
                linea1=proceso+1;
                actualizacion(carro);
                sleep(2);
                ...
                Time=st+quantum;
                cout<<"\n >>>   [se ejecuto el primer proceso durante 1 quantum de un segundo aun falta por ejecutarse mas]\n   ";
                linea1=NULL;
                linea1=proceso+1;
                actualizacion(carro);
                sleep(2);
            ...
            if(tiempoTotal[proceso]<=quantum){
                ...
                cout<<"\n >>>   [el proceso "<<proceso+1<<" termino de ejecutarse porque el tiempo total es menor o igual al quantum]\n   ";
                linea1=NULL;
                linea1=proceso+1;
                actualizacion(carro);
                ...
                Time=st+quantum;
                cout<<"\n >>>   [el proceso "<<proceso+1<<" se ha ejecutado durante 1 quantum de un segundo aun falta por ejecutarse mas]\n   ";
                linea1=NULL;
                linea1=proceso+1;
                actualizacion(carro);
